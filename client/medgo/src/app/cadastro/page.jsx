    ...
    <>
      <section className="flex justify-end items-center bg-slate-100 gap-50 ">
        <form className="grid justify-center items-center gap-6">
          ...
          <p className="text-black">Já possui conta? <Link href="/login" className="text-blue-600">Login</Link></p>
          <div className="grid" >
            <label htmlFor="nome" className="text-black">Nome completo</label>
            <input type="text" name="nome"  required className="w-100 border border-black rounded-2xl text-black" />
          </div>
          <div className="grid" >
            <label htmlFor="nome" className="text-black">CPF</label>
            <input type="number" name="nome"  required className="w-100 border border-black rounded-2xl text-black" />
          </div>
          <div className="grid" >
          ...
          <div className="grid" >
            ...
            <input type="email" name="email"  required className="w-100 border border-black rounded-2xl text-black" />
          </div>
